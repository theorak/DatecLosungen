# -*- coding: utf-8 -*-
#
# DatecLosungen documentation build configuration file, created by
# TYPO3 extension sphinx on Tue, 24 Feb 2015 11:22:04 +0100.
#
...
htmlhelp_basename = 'DatecLosungendoc'
...
latex_documents = [
    ('Index', 'DatecLosungen.tex', u'DatecLosungen',
     u'###AUTHOR###', 'manual'),
]
...
pdf_documents = [
    ('Index', 'DatecLosungen', u'DatecLosungen',
     u'###AUTHOR###'),
]
...
texinfo_documents = [
    ('Index', 'DatecLosungen', u'DatecLosungen',
     u'###AUTHOR###', 'DatecLosungen', 'One line description of project.',
     'Miscellaneous'),
]
